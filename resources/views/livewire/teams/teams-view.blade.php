<div x-show.transition.duration.500ms="view" wire:ignore.self x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform scale-100" x-transition:leave-end="opacity-0 transform scale-90" class="modal absolute right-0 left-0 w-full h-full flex items-center justify-center" style="background-color: rgba(0,0,0,.5);">

    <div class="text-left bg-white lg:p-14 lg:px-52 shadow-xl rounded-lg mx-2 md:mx-0">
        <div class="flex justify-between items-center">
            <div class="text-2xl">Visualizar Time</div>
        ...
        <div>
            ...
            <div class="sm:col-span-6">
                <label for="score" class="block text-sm font-medium text-gray-700">Pontuação</label>
                <div class="mt-1">
                    <input readonly type="text" id="score" wire:model="score" name="score" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                </div>
            </div>
