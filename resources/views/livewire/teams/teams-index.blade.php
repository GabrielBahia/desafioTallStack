                                    ...
                                    <tr>
                                        ...
                                        <td class="flex justify-center">
                                            <div class="pt-3 items-center justify-items-center">
                                                <button @click="view = true" type="button" wire:click.prevent="viewTeam({{ $team->id }})" class="focus:outline-none text-black bg-purple-500 hover:bg-purple-800 focus:ring-4 focus:ring-purple-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-purple-500">
