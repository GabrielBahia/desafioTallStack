    ...
    <div class="text-left bg-white lg:p-14 lg:px-52 shadow-xl rounded-lg mx-2 md:mx-0">
        ...
        <form class="w-96">
            ...
            <div class="flex space-x-4 mt-8">
                <button type="submit" wire:click.prevent="updateTeam" x-ref="closeBtn" class="focus:outline-none focus:ring focus:ring-gray-700 hover:bg-gray-700 border border-gray-700 text-gray-700 hover:text-gray-100 px-4 py-2 rounded no-outline focus:shadow-outline select-none">Editar</button>
