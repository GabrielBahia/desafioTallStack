    ...
    <div x-data="{ edit: @entangle('showEdit')}">
        <div x-data="{ view: @entangle('showView')}">
            ...
            <div class="m-2 p-2">
                ...
                <button @click="create = true" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800  focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Criar Jogador</button>
                </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="flex justify-center">
                                            <div class="pt-6 ">
                                                <button @click="view = true" type="button" wire:click.prevent="viewPlayer({{ $player->id }})" 
