<nav x-data="{ open: false }" class="shadow-2xl bg-violet-700 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboardCampeonatos')" :active="request()->routeIs('dashboardCampeonatos')">
                        {{ __('Dashboard') }}
                    </x-nav-link>

                    <x-nav-link :href="route('jogadores')" :active="request()->routeIs('jogadores')">
                        {{ __('Jogadores') }}
                    </x-nav-link>

                    <x-nav-link :href="route('times')" :active="request()->routeIs('times')">
                        {{ __('Times') }}
                    </x-nav-link>

                    <x-nav-link :href="route('campeonatos')" :active="request()->routeIs('campeonatos')">
                        {{ __('Campeonatos') }}
                    </x-nav-link>
                </div>
            </div>
